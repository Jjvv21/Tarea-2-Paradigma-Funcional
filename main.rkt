...
;Imprime el estado actual del cubo y luego llama a la funcion de movimiento a la derecha;
...
;Imprime el estado actual del cubo y luego llama a la funcion de movimiento a la izquierda;
...
;Imprime el estado actual del cubo y luego llama a la funcion de movimiento hacia arriba;
...
;Imprime el estado actual del cubo y luego llama a la funcion de movimiento hacia abajo;
...
;;Se recorre cuadrante por cuadrante la cara copiando la referencia hasta llegar a la fila deseada,
;;al llegar a esta se copian los valores de la cara esperada, y al terminar se copia el resto de la cara original
...
;;Se recorre cuadrante por cuadrante la cara copiando la referencia hasta llegar a la columna deseada,
;;al llegar a esta se copian los valores de la cara esperada, y al terminar se copia el resto de la cara original
